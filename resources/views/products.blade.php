                    ...
                    <div class="figure-caption">
                        ...
                        @auth
                            <form action="/wishlistAdd" method="post">
                                ...
                                <button type="submit" role="button" class="btn btn-warning  text-white" name="wishlist">Wishlist</button>
                            </form>
                            <form action="/cartlistAdd" method="post">
                                ...
                                <button type="submit" role="button" class="btn btn-warning  text-white" style="margin-bottom:15px" name="addcart">Add To
                                    Cart</button>
                            </form>
                        @else
