...
<a href="index.php" class="navbar-brand">
    ...
    height: 50px;"></div>
            ...
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Bik Shopping</a>
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="nav navbar-nav">
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   ...
                                   <a href="products.php#shirt" class="dropdown-item">Clothing</a>
                                   <a href="products2.php#shoes" class="dropdown-item">Trousers</a>
                       ...
                       <li class="nav-item"><a href="about.php" class="nav-link" >Wishlist</a></li>
                       <?php
